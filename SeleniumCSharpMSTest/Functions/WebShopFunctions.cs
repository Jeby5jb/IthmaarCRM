...
{
    public class WebShopFunctions : Helper
    {
        /// <summary>
        ...
        public void Webdemo(IWebDriver driver, ExtentTest testInReport,  string testName, string testDataIteration, string hitUrl, string username)
        {
            try
            {
                ...
                Element(driver, Control("Computer", "Webshop")).Click();
                ThinkTime(2);
                Element(driver, Control("Desktop", "Webshop")).Click();
                ThinkTime(2);
