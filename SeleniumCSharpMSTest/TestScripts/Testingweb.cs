...
{
    [TestClass]
    public class Testingweb : BaseClass
    {
        /// <summary>
        ...
        /// </summary>
        [DataSource("System.Data.Odbc", "Dsn=Excel Files;Driver={Microsoft Excel Driver (*.xlsx)};dbq=|DataDirectory|\\DataManager\\TestData.xlsx;defaultdir=.;driverid=1046;maxbuffersize=2048;pagetimeout=5", "Sheet1$", DataAccessMethod.Sequential), TestMethod]
        public void Demo()
        {
            //WebShopFunction
            WebShopFunctions webshp = new Functions.WebShopFunctions();
            webshp.Webdemo(driver, extentTest, testName, testDataIteration, uRL, TestContext.DataRow["UserName"].ToString());

             // MarketingFunctions marketing = new MarketingFunctions();
            //WebShopFunctions login = new WebShopFunctions();

            //Launch and Login to the Application
            //login.Webdemo(driver, extentTest,  testName, testDataIteration, uRL, TestContext.DataRow["UserName"].ToString(), TestContext.DataRow["Password"].ToString());
        ...
        [DataSource("System.Data.Odbc", "Dsn=Excel Files;Driver={Microsoft Excel Driver (*.xlsx)};dbq=|DataDirectory|\\DataManager\\TestData.xlsx;defaultdir=.;driverid=1046;maxbuffersize=2048;pagetimeout=5", "Testdata1$", DataAccessMethod.Sequential), TestMethod]
        public void Test()
        {
